    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-lg px-4 py-12 lg:py-16">
                    ...
                    <div key={index} className="flex gap-2">
                      ...
                      {members.length > 1 && (
                        <Button
                          ...
                          className="shrink-0 border-border text-muted-foreground hover:bg-destructive/10 hover:text-destructive hover:border-destructive/30"
                        >
                          <X className="h-4 w-4" />
        ...
        <p className="mt-6 text-center text-xs text-muted-foreground">
          You can always add more members later from the dashboard settings.
        </p>
      </main>
    </div>
  )
